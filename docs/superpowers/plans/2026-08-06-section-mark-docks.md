...
## المهمّة ١: فحص `docks()` في الحصّالة
...
## المهمّة ٢: نشر `MARK_BOXES` للحصّالة
...
## المهمّة ٣: الأهداف الستّة في `page.tsx`
...
## المهمّة ٥: بوابة التغطية والتدهور الآمن

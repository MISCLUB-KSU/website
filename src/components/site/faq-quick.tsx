...
/**
 * الأسئلة الشائعة على الرئيسية — **الشكل من لقطة الإدارة، والألوان من الوضع**.
 *
 * ⚠️⚠️ **قاعدة هذا الملف: لا يُحسَّن المرجع، يُنفَّذ.**
 *
 * سبقت محاولاتٌ رُفضت كلّها لسببٍ واحد: كنت أعدّل ما ترسله الإدارة بحجّتي
 ...
 * وحنا في وضع الـ light mode؟ … خلّ الخلفية متناسقة» (الإدارة، ٧ أغسطس ٢٠٢٦).
 *
    ...
    >
      <div className="mx-auto w-full max-w-4xl px-s4 sm:px-s7">
        {/* ═══ مرسى اجتماع العلامة ═══
            ...
            الاجتماع في التذييل، ونُقل إلى هنا بطلبٍ صريح (الإدارة، ٧ أغسطس

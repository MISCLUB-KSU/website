...
export function SiteFooter() {
  ...
  return (
    <footer className="raked-field grain text-on-ink">
      ...
      {/* توقيع التذييل — الشعار ملتصقٌ بالحافّة السفلى بلا فجوة تحته،
          فيُقرأ توقيعًا لا نصًّا مركونًا.

          ⚠️⚠️ **ساكنٌ بلا مرساة — ولا يُعاد إليه `data-mark-anchor` أبدًا.**
          كان هنا مرساةُ اجتماع العلامة، ونُقل الاجتماع إلى قسم «الأسئلة
          الشائعة» بطلبٍ صريح (حسام، ٧ أغسطس ٢٠٢٦). فحُذف الشعار معها، فبان
          أثرٌ لم يكن في الحسبان: **آخر ربع الصفحة صار بلا أي علامة** —
          مقيسًا، عند 90% من التمرير ثلاثةُ أضلاعٍ على الشاشة وعند 100%
          صفر، لأن المجتمعة ملتصقةٌ بمرساةٍ أعلى فتنزلق معها. فيُقرأ القاعُ
          فارغًا ويُظنّ التشكّل محذوفًا وهو حيّ.

          فالشعار عاد **رسمًا ساكنًا** يملأ القاع، والاجتماع باقٍ عند
          الأسئلة. ولو أُعيدت المرساة هنا لعاد الاجتماع إلى القاع وضاع
          الطلب.

          ⚠️ `data-mark-static` **لا تُوضع هنا**: هي علامةٌ تُخفى حين تحلّ
          محلَّها أضلاعُ الطبقة المتشكّلة — ولا شيء يحلّ محلّ هذا، فيبقى
          ظاهرًا دائمًا. */}
      {/* ⚠️ **حشو الجهتين على غلافٍ خارجيٍّ يحيط بالمرساة، لا على
          `[data-mark-anchor]` نفسها.** `getBoundingClientRect` يشمل الحشو
          دائمًا، بينما الشعار الساكن بداخلها يملأ صندوق *المحتوى* وحده —
          فحشوٌ على المرساة يكبّر `kFoot` عن حجم الشعار المرسوم فعليًّا.
          قِيس سابقًا: على 1280 المتشكّل 1152px@x=64 مقابل الساكن
          1056px@x=112. */}

...
export function SiteFooter() {
  ...
  return (
    <footer className="raked-field grain text-on-ink">
      ...
      {/* ⚠️ **كان هنا اجتماع العلامة — شعارٌ بعرض التذييل ملتصقٌ بحافّته
          السفلى، ومرساةُ `[data-mark-anchor="foot"]`.** حُذف بطلبٍ صريح
          (حسام، ٧ أغسطس ٢٠٢٦): «واللي تحت بالفوتر شِله، ما أبيه». وانتقل
          الاجتماع إلى قسم «الأسئلة الشائعة» في الرئيسية — انظر مرساة
          `[data-mark-anchor="rest"]` في `faq-quick.tsx`.

          فلا يُعاد شعارٌ ضخمٌ هنا ظنًّا أنه سقط سهوًا. والعلامة الصغيرة في
          سطر الكولوفون أعلاه باقيةٌ وكافية. */}
    </footer>
  );
}

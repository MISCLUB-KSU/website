...
export default async function AdminPage() {
  ...
  return (
    ...
    <main className="dash mx-auto flex w-full max-w-[110rem] flex-col px-s4 pb-s4 lg:h-[100svh]">
      ...
      {/* ⚠️ **للرئاسة وحدها، ولا يُقال «فشل».**
          كان يظهر لكلّ قائدٍ بصيغة «لم يخرج بريدُ وصل طلبك — راجع لوحة
          Resend». وهو اليوم **٢٤٤ من ٢٤٤**، فيستقبل كلُّ قائدٍ في أوّل يومٍ
          لافتةً حمراءَ تقول إن كلَّ شيءٍ فشل — وهي:

            · **لا تخصّه** — الإرسالُ قرارُ إدارةٍ ونطاقٌ لم يُوثَّق، لا شيء
              يملك القائدُ فعلَه حياله. فتُقلقه بلا فائدة.
            · **وليست فشلًا** — الإيصالُ لم يُوعَد به أصلًا (حُذف الوعدُ من
              الموقع في ١٧ أغسطس). فوصفُه «لم يخرج» يصف امتناعًا كأنه عطل.

          والرقمُ يبقى للرئاسة لأنه يقيس شيئًا حقيقيًّا: **قناةُ البريد غيرُ

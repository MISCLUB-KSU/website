...
export default async function AdminPage() {
  ...
  return (
    ...
    <main className="dash mx-auto flex w-full max-w-[110rem] flex-col px-s4 pb-s4 lg:h-[100svh]">
      ...
      {/* ⚠️ **لافتةُ «قناةُ البريد غيرُ موصولة» رُفعت (١٩ أغسطس ٢٠٢٦).**

         كانت تظهر للرئاسة ما دام لم يخرج إيصالٌ واحد — أي **كلَّ يومٍ بلا
         انقطاع**، لأن النطاق غيرُ موثَّقٍ في Resend وتوثيقُه سجلّاتُ DNS
         داخل Vercel، **بيد صاحب الحساب لا بأيدينا**. فكانت:

           · **تقول ما هو معلوم** — الرئاسةُ تعرف أن القناة مقطوعة، ولا
             يضيف تكرارُ الخبر يوميًّا شيئًا إلى قرارها.
           · **ولا فعلَ خلفها** — لافتةٌ تُنبّه على ما لا يملك قارئُها
             تغييرَه تصير أثاثًا يُتخطّى بالعين، فتُضعف كلَّ لافتةٍ بعدها.
           · **وتأكل سطرًا** — والشاشةُ مبنيّةٌ على ألّا تُمرَّر، فكلُّ سطرٍ
             هنا يُخصم من ارتفاع الجدول أسفلَه.

         وبقيت اللافتةُ الجزئيّة تحتها: تلك تظهر عند **خللٍ في الحصّة** —
         بعضُهم وصله وبعضُهم لا — وذاك فعلٌ يُراجَع في Resend. والحالُ
         الدائمة تُقرأ من `HANDOVER.md §٧` لا من شاشةٍ يوميّة. */}

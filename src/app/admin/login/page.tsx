...
/**
 * دخول الإدارة والقادة — برابطٍ يصل البريد، بلا كلمة مرور.
 *
...
export default function AdminLoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-md flex-col justify-center px-5 py-14">
      ...
      {/* ⚠️ كان «دخول الطاقم» — غُيّر بطلب حسام (١١ أغسطس ٢٠٢٦).
          والعنوانُ يسمّي **من يدخل** لا الفعل: اللوحةُ واحدةٌ يقصّها RLS،
          يدخلها الإدارةُ وقادةُ اللجان والمشاريع، فيعرف القائدُ أنه معنيٌّ
          بها قبل أن يكتب بريده. */}
      <h1 className="text-fg mb-3 text-2xl font-bold sm:text-3xl">
        دخول الإدارة والقادة
      </h1>

...
type LeapFormProps = {
  /** نصُّ التعريف — يأتي من مكوّن الخادم فلا يُحزَم في حزمة المتصفّح */
  children: ReactNode;
};
 ...
 * لحظةً بلحظة، ووجهُها الخلفيُّ يعرض البزنس كارد الذي سيأخذه. ولا يمنع
 * ذلك من عطّل الجافاسكربت — النموذجُ `<form>` حقيقيٌّ يقصد `Server Action`،
 * والقيمُ الأوّليّة تُقرأ من الحالة المعادة، فمن أخطأ بلا جافاسكربت يرجع
 * فيجد ما كتبه في مكانه.
 */
    ...
    <>
      ...
      {done ? (
        <div className="leap-done">
          <h2>تم تسجيلك</h2>
          <p>
            وصلَنا اسمك ورقم حجزك. البطاقة فوق هي اللي بتُطبع لك — ولو فيه
            خطأ في الاسم أو الرقم، كلّم قادة النادي قبل الفعالية.
          </p>
        </div>
      ) : (
        <>
          ...
          <form className="leap-form" action={formAction} noValidate>
            <div className="leap-group">
              ...
              <span className="leap-hint">
                الاسمان يُطبعان على البطاقة كما تكتبهما — راجعهما فوق.
              </span>
            </div>

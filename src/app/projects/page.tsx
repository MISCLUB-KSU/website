 ...
 *
 * ⚠️ **ورابطُ التنقّل باقٍ في الشريط والتذييل — بقرار حسام صراحةً.** فهذي
  ...
  return (
    <>
      ...
      >
        ...
        {/* ⚠️ **كانت هنا جملةٌ حُذفت: «وحتى ذلك الحين، المشاريع تعمل ولم
            تتوقّف».** كُتبت لتمنع سوء فهمٍ متوقَّعًا (أن يُقرأ إغلاقُ
            الصفحة إغلاقًا للمشاريع)، لكنها **ادّعاءٌ بلا سند**: لا شيء في
            المستودع يُثبت أن مشروعًا يعمل اليوم — الستّ جهات
            `applicationState: "closed"`، والواجهة نفسها تقول «التقديم مغلق
            حاليًّا». فكانت تطمينًا يناقض ما تقوله الصفحةُ الأولى.
            وبديلُها يقول ما **يُثبَت**: أن ما أُنجز منشورٌ بمصادره. */}
        <p className="text-fg-muted mt-s4 max-w-[46ch] text-lead leading-relaxed">
          ...
          نعرضه. وما أنجزته المشاريع منشورٌ بمصادره في{" "}
          <Link
            href="/achievements"
            className="text-fg decoration-line-control underline underline-offset-4 transition-colors hover:text-accent"
          >
            صفحة الإنجازات
          </Link>
          .

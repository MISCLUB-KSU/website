...
export async function submitRegistration(
  ...
  return {
    ...
    errors: {},
    values: {},
    /* ⚠️ **الإيصالُ يُسمّى، والنتيجةُ لا قناةَ لها — عمدًا** (١٦ أغسطس ٢٠٢٦).
       القبولُ واتساب والرفضُ بريد، فذكرُ القناة يجعل **وصولَ الرسالة نفسِه**
       إعلانًا بالنتيجة قبل أن تُفتح: «لا تعلم أحد إنهم بينقبلون».
       والإيصالُ يُستثنى لأنه يصل **الجميع** — فوصولُه لا يفرّق بين مقبولٍ
       ومرفوض، بل يُعمّي رسالةَ الرفض التي تليه في الصندوق نفسِه. */
    message:
      "وصل طلبك، ويصلك إيصالٌ على بريدك. وتصلك النتيجة خلال أسبوعين عمل.",

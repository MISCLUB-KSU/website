  ...
  return (
    ...
    >
      <TextField
        ...
        error={e.fullName}
        /* بلا سطر إرشاد — قرار الإدارة. والمعنى لم يضع: النائبُ داخل الحقل
      ...
      <div className="grid gap-s5 sm:grid-cols-2">
        <TextField
          ...
          error={e.phone}
          /* ⚠️ **لا يُذكر أن النتيجة تأتي هنا — والقناةُ تفضح القرار.**
             كُتب في أوّل صياغة «وتصلك النتيجة عليه في واتساب»، ثم رُفع
             ذلك في اليوم نفسِه بقرار الإدارة: «لا تعلم أحد إنهم بينقبلون».
             القبولُ واتساب والرفضُ بريد، فذكرُ القناة يجعل **وصولَ الرسالة
             نفسِه** إعلانًا بالنتيجة قبل أن تُفتح.

             والحاجةُ إلى رقمٍ صحيحٍ باقية، فيُقال سببٌ صادقٌ لا يكشف: قد
             نتواصل. */
          hint={
            <>
              يبدأ بـ <span dir="ltr">05</span>، وقد نتواصل معك عليه.
            </>
          }

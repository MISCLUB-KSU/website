    ...
    >
      ...
      <div className="grid gap-s5 sm:grid-cols-2">
        <TextField
          ...
          error={e.phone}
          /* ⚠️ **الواتساب يُذكر في التلميح لا في مكانٍ آخر** (١٦ أغسطس ٢٠٢٦،
             بقرار الإدارة: «القبول راح يكون على الواتس»). صار هذا الحقلُ
             قناةَ الجواب، ومن كتب رقمًا لا واتساب عليه لا تصله نتيجتُه —
             ولا يعرف السبب. والتلميحُ يبقى بعد الكتابة، فيراه وهو يراجع. */
          hint={
            <>
              يبدأ بـ <span dir="ltr">05</span>، وتصلك النتيجة عليه في واتساب.
            </>
          }

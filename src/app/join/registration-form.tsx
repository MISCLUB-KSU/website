  ...
  if (state.ok) {
    return (
      ...
      >
        ...
        {/* ⚠️ **القناتان تُسمَّيان صراحةً** (١٦ أغسطس ٢٠٢٦): الإيصالُ بريد،
            والنتيجةُ واتساب. وكان النصّ يعِد بالبريد للاثنين، فيراقب الطالبُ
            صندوقَه أسبوعًا على رسالةٍ لا تأتي — ورقمُه هو ما يجب أن ينتبه له. */}
        <p className="text-fg-muted mx-auto max-w-[44ch] leading-relaxed">
          راجعنا بياناتك واستلمناها، ويصلك إيصالٌ على بريدك. والنتيجة تصلك على
          واتساب خلال أسبوع.
        </p>

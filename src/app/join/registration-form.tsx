  ...
  if (state.ok) {
    return (
      ...
      >
        ...
        {/* ⚠️ **الإيصالُ يُسمّى قناتَه، والنتيجةُ لا** (١٦ أغسطس ٢٠٢٦).
            التعليلُ كاملًا عند الرسالة نفسِها في `actions.ts`: القناةُ تفضح
            القرار، والإيصالُ وحده يصل الجميع فلا يفضح شيئًا. */}
        <p className="text-fg-muted mx-auto max-w-[44ch] leading-relaxed">
          راجعنا بياناتك واستلمناها، ويصلك إيصالٌ على بريدك. وتصلك النتيجة خلال
          أسبوعين عمل.
        </p>
